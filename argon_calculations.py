...
from pychron_constants import FLECK
...
class ArArConstants:
    ...
    atm4036_citation = ''  # 'Nier (1950)'
    atm4038_citation = ''  # 'Nier (1950)'
    lambda_b_citation = ''  # 'Min (2008)'
    lambda_e_citation = ''  # 'Min (2008)'
    lambda_Ar39_citation = ''  # 'Min (2008)'
    lambda_Ar37_citation = ''  # 'Min (2008)'
    use_irradiation_endtime = False

    allow_negative_ca_correction = True
    trapped_atm4036 = None

    # cosmogenic
    use_cosmogenic_correction = False
    solar3836_v = 0
    solar3836_e = 0
    ...
    @property
    def atm4038(self):
        return ufloat(self.atm4038_v, self.atm4038_e)
    ...
    @property
    def lambda_b(self):
        return ufloat(self.lambda_b_v, self.lambda_b_e, tag='lambda_b')

    @property
    def lambda_e(self):
        return ufloat(self.lambda_e_v, self.lambda_e_e, tag='lambda_e')
